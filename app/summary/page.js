...
export default async function SummaryPage(){
 ...
 return <><ExportPage date={source.date}/><ArticleFilter/><PdfLinkHandler/><div className="summary-content"><main id="rassegna-oggi" className="summary-edition"><EditionView hideBrand body={summaryEdition(source)} categoryOrder={summarySections} compactAnalysis/></main></div></>;
}
