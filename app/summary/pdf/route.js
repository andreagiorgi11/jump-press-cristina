...
export async function GET(request){
 ...
 const bytes=summary?await exportSummaryPdf(JSON.parse(await readFile(process.cwd()+'/.local/summary-preview.json','utf8')),source.date):await exportEditionPdf(source);
