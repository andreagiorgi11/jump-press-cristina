...
export default function PublishedHome({result,legacy}){
 ...
 if(process.env.NEXT_PUBLIC_JUMP_APPROVAL_LIVE==='1')return <>{result.unavailable&&<p role='alert'>Aggiornamento non disponibile. Stai visualizzando l’ultima versione caricata.</p>}<ApprovalEdition body={row.body}/></>;
