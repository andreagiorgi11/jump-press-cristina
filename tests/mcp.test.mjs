...
test('Summary MCP exposes required editorial flag, five Summary sections and the Nazionale article category',async()=>{
 ...
 assert(p.articles.items.required.includes('isEditorial'));assert.deepEqual(p.articles.items.properties.category.enum,['Prima squadra','Next Gen e Primavera','Juventus Women','Politica sportiva','Nazionale','Altri temi']);
