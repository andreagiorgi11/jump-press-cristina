...
export class MemoryStore {
 ...
 async commit(files,head){if(head.sha!==String(this.version))throw Object.assign(problem(409,'Conflitto concorrente'),{storeConflict:true});Object.assign(this.files,structuredClone(files));this.snapshots.push(structuredClone(this.files));this.version++;}
}
