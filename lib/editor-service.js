...
export async function saveDraft(ctx,id,version,input){
 ...
 if(old?.body.editorialModel==='summary-v1'){body.editorialModel='summary-v1';if(editorialContent(old.body)!==editorialContent(body)&&JSON.stringify(body.executiveSummary)===JSON.stringify(old.body.executiveSummary))body.executiveSummary=null;}
