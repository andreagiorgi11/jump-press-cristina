...
import {renderSourcePage} from './source-pdf.js';
...
export async function deleteDraft(ctx,id,version){
 ...
 if(d.publishedVersions?.length||index.published.some(x=>x.draft_id===id))throw problem(409,'Questa rassegna è già pubblicata e non può essere eliminata come bozza.');
