...
export async function exportSummaryPdf(summary,date,fonts){
 ...
 page.drawRectangle({x:left,y:798,width:4,height:13,color:lime});text('JUMP PRESS',left+12,800,10,bold);
 ...
 text(formatted,left+width-font.widthOfTextAtSize(formatted,9),800,9,font,muted);
 text('Juventus',left,759,29,bold);text('Il briefing del giorno',left,738,11,font,muted);
 text('SUMMARY',left+width-bold.widthOfTextAtSize('SUMMARY',9),760,9,bold,muted);
