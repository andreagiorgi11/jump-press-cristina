...
import {blobs,usesFileServer} from './blob-store.js';
// The AG Studio file server returns its whole inventory in one page.
const serverList=async()=>({...(await blobs.list()),hasMore:false});
