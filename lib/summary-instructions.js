...
Compila keyPoints con da uno a cinque punti rilevanti per la Juventus, distinguendo aspetti positivi e negativi. Ogni stringa inizia con "Positivo: " oppure "Negativo: ", seguita da un titolo breve, due punti e una frase che spiega perché conta, fondata sugli articoli selezionati. Esempio di formato: "Positivo: Titolo breve: spiegazione verificata." Il sito e il PDF raggruppano i punti in "Segnali positivi" e "Criticità" sotto "La giornata in sintesi". Non inventare valutazioni e non trasformare ipotesi in fatti. Non ci sono quote per tipo e non è obbligatorio rappresentare entrambi: scegli solo ciò che le fonti sostengono. Questa regola sostituisce ogni precedente richiesta di esattamente tre punti. I vecchi punti privi di etichetta restano leggibili come punti chiave non classificati.
