...
let base=source;
base=base.replace("Seleziona e riassumi i contenuti più rilevanti della rassegna stampa, con priorità assoluta alla Juventus. Non limitarti all’indice: leggi realmente gli articoli e individua le informazioni più importanti.","Devi analizzare integralmente tutto il PDF, non limitarti all’indice, ai titoli o ai risultati OCR. Devi leggere realmente gli articoli che possono essere rilevanti e, quando necessario, controllare visivamente la pagina originale. La priorità assoluta è la Juventus.");
...
base=base.replace(/- Tutti gli articoli classificati Editoriali[^\n]*/g,'- Classifica tutti gli articoli, inclusi gli editoriali, nelle cinque aree del modello Summary.');
base=base.replace(/- editoriali subito dopo;/g,'- articoli ordinati nelle cinque aree;');
...
return withAutomaticEditorialRules(applyApprovedEditorialRules(base)+`
...
Compila keyPoints con da uno a cinque punti rilevanti per la Juventus, distinguendo aspetti positivi e negativi. Ogni stringa inizia con "Positivo: " oppure "Negativo: ", seguita da un titolo breve, due punti e una descrizione breve fondata sugli articoli. Il titolo appare sopra, la descrizione su una sola riga sotto nella vista desktop: la descrizione deve essere indicativamente lunga circa il doppio del titolo (orientativamente 45–65 caratteri), senza sacrificare significato o incertezze. Non inserire ritorni a capo nel campo. Esempio di solo formato: "Positivo: Titolo breve: Descrizione breve del fatto rilevante." Il sito e il PDF raggruppano i punti in "Segnali positivi" e "Segnali di criticità" sotto "La giornata in sintesi". Non inventare valutazioni e non trasformare ipotesi in fatti. Non ci sono quote per tipo e non è obbligatorio rappresentare entrambi: scegli solo ciò che le fonti sostengono. Questa regola sostituisce ogni precedente richiesta di esattamente tre punti. I vecchi punti privi di etichetta restano leggibili come punti chiave non classificati.
...
SENTIMENT JUVENTUS — TUTTI GLI ARTICOLI SELEZIONATI
Valuta tutti e soltanto gli articoli selezionati, non il PDF integrale e non i keyPoints. Per ciascun articolo compila juventusSentiment={tone:"positivo|negativo|neutro|misto",reason:"Motivo concreto fondato sulla fonte"}. Valuta il tono e le implicazioni per la Juventus, non se la notizia sia positiva per altri soggetti. Neutro quando non emerge un orientamento per la Juventus, misto quando coesistono segnali contrastanti. Non dedurre il tono dalla categoria o dal rating e non inventare nessi con la Juventus. La lancetta aggrega tutte le valutazioni con uguale peso; neutro e misto contribuiscono al centro. Una valutazione mancante lascia il sentiment da completare, non equivale a neutro. Se cambia il contenuto di un articolo, ricontrolla la valutazione e la motivazione. Il testo toneSummary può spiegare l'equilibrio della giornata senza dipendere dal numero dei punti positivi e negativi mostrati.
