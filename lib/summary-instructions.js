...
let base=defaultEditorialText;
base=base.replace(/ORDINE DELLA RASSEGNA\n[\s\S]*?(?=CAPPELLO INIZIALE\n)/,categories+'\n\n');
base=base.replace(/CATEGORIE E ORDINE — REGOLA VINCOLANTE[\s\S]*$/,categories);
...
export const summaryEditorialText=base+`
