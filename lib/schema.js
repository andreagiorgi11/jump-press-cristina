...
export const articleSchema=z.object({
  id:z.string().uuid(), category:text.min(1).max(100), title:text.min(1).max(400),
...
export const editionSchema=z.object({
  ...
  coverage:z.object({
    ...
    frontPages:z.array(z.object({outlet:text.min(1).max(150),page:z.number().int().positive(),juventus:z.boolean(),nationalSports:z.boolean()}).strict()).max(500).nullable(),
