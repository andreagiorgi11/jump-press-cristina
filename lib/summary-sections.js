...
export const shortSectionLabels={'Prima squadra':'Squadra','Next Gen e Primavera':'Next Gen','Juventus Women':'Women','Politica sportiva':'Politica','Altri temi':'Altri temi'};
...
export function summaryEdition(body){return {...body,executiveSummary:normalizeExecutiveSummary(body.executiveSummary),articles:body.articles.map(a=>({...a,isEditorial:isEditorial(a),category:summaryCategory(a)}))};}
