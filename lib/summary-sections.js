...
export function summaryEdition(body){
 ...
 const mapping={'Editoriali':'Prima squadra','Mercato':'Prima squadra','Società e dirigenza':'Prima squadra','Arbitri e VAR':'Politica sportiva','Prima squadra':'Prima squadra','Prossimo avversario':'Prima squadra','Juventus Women':'Prima squadra femminile','Politica sportiva':'Politica sportiva'};
 return {...body,articles:body.articles.map(a=>({...a,category:mapping[a.topic]||mapping[a.category]||'Temi vari'}))};
}
