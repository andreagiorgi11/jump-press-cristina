...
export function editorialContent(body){return JSON.stringify({date:body.date,intro:body.intro,articles:body.articles.map(({id,category,title,summary,topic})=>({id,category,title,summary,topic}))});}
