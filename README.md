...
La candidata locale e il testo iniziale sono riallineati: categoria Competizioni europee, checklist conclusiva unica, importazione e ritagli tramite MCP a gruppi. Nomi e lunghezze restano invariati in attesa delle sintesi del 13 settembre (l’archivio storico locale contiene solo titoli e ritagli). La scadenza degli originali indica idoneità alla rimozione, non cancellazione automatica: read_editorial_instructions non chiama purgeOriginals. Questa revisione non attiva manutenzioni né cancella file.
